...
| Render / Koyeb / Railway / Fly.io 等 PaaS | `ghcr.io/x-dora/rw-node:latest-paas` | 内置 Caddy HTTP 前置，支持 HTTPS 域名直连和静态页面伪装 |
...
| `ghcr.io/x-dora/rw-node:latest-paas` | PaaS HTTPS 直连版，内置 Caddy HTTP 前置 |
